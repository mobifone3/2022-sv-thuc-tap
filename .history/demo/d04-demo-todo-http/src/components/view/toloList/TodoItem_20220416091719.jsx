    ...
    <li className={`row todo_item ${isCheck ? "bg-info text-light" : ""}`}>
      <div className="col-8">
        {isEdit ? (
          <input
            ...
            onChange={(e) => handleOnChangeEdit(e, { id, name, isCheck, isEdit })}
      ...
      <div className="col-4 d-flex justify-content-end">
        <div className="form-check">
          ...
          {isEdit ? (
            <i
              className="fa-solid fa-check todo_icon_pen text-success"
              style={commonStyle}
              onClick={() => handleSwitchEdit(id, name, { id, name, isCheck, isEdit })}
            ></i>
          ) : (
            <i
              className="fa-solid fa-pen todo_icon_pen"
              style={commonStyle}
              onClick={() => handleSwitchEdit(id, name, { id, name, isCheck, isEdit })}
            ></i>
          )}
