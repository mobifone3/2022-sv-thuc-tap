      ...
      <div className="col-4 d-flex justify-content-end">
        <div className="form-check">
          <input
            ...
            id="flexCheckDefault"
          />
          {isEdit ? <i className="fa-solid fa-check todo_icon_pen text-success" style={commonStyle} onClick={() => handleSwitchEdit()}></i> : <i className="fa-solid fa-pen todo_icon_pen" style={commonStyle} onClick={() => handleSwitchEdit()}></i>}
