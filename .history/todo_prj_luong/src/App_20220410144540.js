...
function App() {
  ...
  const handleClickDone = (e) => {
    let dataDone = listData.filter((item) => item.isCheck === true);
    setDone(dataDone);
    let dataTodo = listData.filter((item) => item.isCheck === false);
    setTodo(dataTodo);
    /** */
    console.log(done);
    setListData(done);
  ...
  const handleDeleteDone = (e) => {
    let data = listData.filter((item) => item.isCheck !== true);
    ...
    <div className="App">
      <div className="todo">
        ...
        <div className="todo_main">
          ...
          <TodoList todoLists={listData} handleCheckBox={handleCheckBox}></TodoList>
