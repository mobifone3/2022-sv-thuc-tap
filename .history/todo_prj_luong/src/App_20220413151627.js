...
export default function App() {
  ...
  const handleKeyPress = (e) => {
    if (e.key === "Enter") {
      ...
      let name = newList[foundIdx].name;
      console.log(name);
      console.log("valueinput", inputEdit);
      console.log(newList[foundIdx]);
      // newList[foundIdx].replace(name, inputEdit);
      newList.spice(foundIdx, 0, inputEdit);
      console.log(newList);
